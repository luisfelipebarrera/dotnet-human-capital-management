## dotnet-human-capital-management

Solution for management human capital.
...
# Export base64
grep -v '^-' my_private.key | tr -d '\r\n '
grep -v '^-' my_public.key | tr -d '\r\n '
```

**.env**

```bash
Jwt__Issuer=https://my-poc-api.com
Jwt__Audience=https://my-poc.com
